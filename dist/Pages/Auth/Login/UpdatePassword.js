...
export default function UpdatePassword() {
    ...
    return (_jsxs(Box, { sx: {
            ...
            borderRadius: 4,
        }, children: [_jsx(Typography, { variant: "h5", component: "h1", gutterBottom: true, textAlign: "center", children: "Update Your Password" }), _jsxs("form", { onSubmit: handleSubmit(onSubmit), children: [_jsx(TextField, { label: "New Password", variant: "outlined", type: "password", fullWidth: true, margin: "normal", ...register("newPassword", { required: "NewPassword is required" }), error: !!errors.newPassword, helperText: (_a = errors.newPassword) === null || _a === void 0 ? void 0 : _a.message }), _jsx(TextField, { label: "Confirm New Password", variant: "outlined", type: "password", fullWidth: true, margin: "normal", ...register("confirmNewPassword", {
