...
function Navbar() {
    ...
    var profileImage = localStorage.getItem("profile") || "";
    ...
    return (_jsx(AppBar, { position: "static", sx: { bgcolor: "teal" }, children: _jsx(Container, { maxWidth: "xl", children: _jsxs(Toolbar, { disableGutters: true, children: [_jsx(Typography, { variant: "h6", noWrap: true, component: "a", href: "#app-bar-with-responsive-menu", sx: {
                            ...
                            color: "inherit",
                            textDecoration: "none",
                        }, children: "LOGO" }), _jsxs(Box, { sx: { flexGrow: 1, display: { xs: "flex", md: "none" } }, children: [_jsx(IconButton, { size: "large", "aria-label": "account of current user", "aria-controls": "menu-appbar", "aria-haspopup": "true", onClick: handleOpenNavMenu, color: "inherit", children: _jsx(MenuIcon, {}) }), _jsx(Menu, { id: "menu-appbar", anchorEl: anchorElNav, anchorOrigin: {
                                    vertical: "bottom",
                                    horizontal: "left",
                                ...
                                }, children: pages.map(function (page) { return (_jsx(Link, { to: page.p, style: { textDecoration: "none" }, children: _jsx(MenuItem, { onClick: handleCloseNavMenu, children: _jsx(Typography, { textAlign: "center", children: page.page }) }) }, page.page)); }) })] }), _jsx(AdbIcon, { sx: { display: { xs: "flex", md: "none" }, mr: 1 } }), _jsx(Typography, { variant: "h5", noWrap: true, component: "a", href: "#app-bar-with-responsive-menu", sx: {
                            mr: 2,
